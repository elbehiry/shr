...
const translations: Record<string, Record<string, string>> = {
  sv: {
    ...
    // New additions
    readyForCleaner: 'Är du redo att få ett renare hem? Kontakta oss för att boka en städning eller begära en offert.',
    getInTouch: 'Kontakta oss',
    serviceAreas: 'Serviceområden',
    serviceAreasDescription: 'Vi är stolta över att erbjuda våra förstklassiga städtjänster i följande områden:',
    notSure: 'Inte säker om vi betjänar ditt område? Ring oss för att ta reda på!',
    quickLinks: 'Snabblänkar',
    contactInformation: 'Kontaktinformation',
    phone: 'Telefon',
    email: 'E-post',
    professionalServices: 'Vi tillhandahåller professionella städtjänster med fokus på kvalitet och kundnöjdhet.',
  },
  en: {
    // General
    title: 'SHR städ',
    ...
    // New additions
    readyForCleaner: 'Ready for a cleaner home? Contact us to book a cleaning or request a quote.',
    getInTouch: 'Get in touch',
    serviceAreas: 'Service Areas',
    serviceAreasDescription: 'We proudly provide our exceptional cleaning services to the following areas:',
    notSure: 'Not sure if we serve your area? Call us to find out!',
    quickLinks: 'Quick Links',
    contactInformation: 'Contact Information',
    phone: 'Phone',
    email: 'Email',
    professionalServices: 'We provide professional cleaning services with a focus on quality and customer satisfaction.',
  },
};
